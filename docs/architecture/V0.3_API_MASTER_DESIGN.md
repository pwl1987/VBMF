# VBMF V0.3 — API Master Design

> **Status: LOCKED FOR DETAILED DOMAIN CONTRACT DESIGN**  
> Date: 2026-09-11  
> Scope: VBMF V0.3 Control / Query / Command / Event API 的顶层 namespace、语义边界、版本策略、扩展机制与 SDK 演进规则。
>
...
## 1. API Freeze Decision

VBMF V0.3 API 现在正式进入：

> **TOP-LEVEL API FROZEN**
...
# 19. API and Media Plane Separation
...
# 21. SDK Strategy — Contract First, SDK Second
...
# 24. Relationship with Mother Framework
