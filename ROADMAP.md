...
Phase 0.5  Operator Workflow & Wireframe   ✅ 完成 (9 页面 + 4 链)
Phase 0.6  Reference + Fault Injection     📋 Next (待启动)
Phase 1    Media Core (Rust + 24h stab)    📋 After 0.6 acceptance
Phase 2    Backend Foundation              📋
Phase 2.5  Graph Compiler / Preflight      📋
Phase 3    Auth & RBAC                     📋
Phase 3.5  UI Prototype & Validation       📋
Phase 4    Web Console                     📋
Phase 5    Signal Fabric                   📋
Phase 5.5  Health Tree & Incident UI       📋
V0.3       Architecture Extension          📋 任何架构级扩展必须开 V0.3
V0.4       Broadcast Grade (PTP/SDI/HA)    📋
V0.5       WebRTC + 浏览器上行             📋
V1.0       完整 IP 播控                    📋
```
...
- 9 Low-Fi HTML Wireframes (Dark Mode 24/7)：
...
- **5 Fault Injection**：
  ...
  - FI-03: Primary FFmpeg 崩溃 → PIPELINE → RESTART
...
## Phase 1 — Media Core (Rust + 24h stability) 📋
...
| 阶段 | 社区协作 |
|---|---|
| Phase 0.5 | 公开 9 wireframe + 4 链，欢迎 UI / UX 反馈 |
